...
export function reducer(state = initialState, action: {type: string, payload: any}): State {  // 状态发送变化
    switch (action.type) {
        case actions.ActionTypes.LOAD_SUCCESS:
            return {...state, quote: action.payload as Quote};  // 相当于Object.assign({}, state, {quote: action.payload})
